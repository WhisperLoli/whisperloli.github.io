...
description: ''
color: 'rgb(255,90,90)'
cover: '/blog/blog_spider_douyin/test.png'
subtitle: 'mitmproxy+appium+python实现自动化爬虫'
---
...
2. 启用代理
	...
	<img src="/blog/blog_spider_douyin/mobileconfigproxy.jpeg" width="390px" height="690px" >
	...
	<img src="/blog/blog_spider_douyin/certificate.jpeg" width="390px" height="690px" >
	...
	![image](/blog/blog_spider_douyin/requests.jpg)
...
3. 配置android环境
	...
	![image](/blog/blog_spider_douyin/sdkmanager.jpg)
...
4. adb调试
	...
	![image](/blog/blog_spider_douyin/vendorid.jpg)
	...
	<img src="/blog/blog_spider_douyin/startusb.jpeg" width="390px" height="690px" >
	
	<img src="/blog/blog_spider_douyin/configusb.jpeg" width="390px" height="690px" >
...
5. 配置appium
	...
	![image](/blog/blog_spider_douyin/appiumui.jpg)
	
	再点击上图中红色框中的按钮
	
	![image](/blog/blog_spider_douyin/appiumconfig.jpg)
...
class Action():
    ...
    def main(self):
        self.comments() #开启会先睡眠10s，手机上需要给app授权
        self.scroll() #滑动屏幕
...
爬取的视频如下，爬取到的视频是不带有抖音水印的噢！

![image](/blog/blog_spider_douyin/video.jpg)
